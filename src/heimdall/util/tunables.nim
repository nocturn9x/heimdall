...
DoubleExtMargin, 37
CutNodeLMRScale, 2071
NodeTMBaseOffset, 2728
NMPEvalMinimum, 3
NodeTMDepthThreshold, 5
SEEPruningQuietMargin, 78
SEEPruningCaptureMargin, 160
NMPEvalDivisor, 228
BadQuietMalus, 350
SEReductionDivisor, 2
TTCaptureLMRScale, 1090
NMPDepthThreshold, 1
...
GoodQuietBonus, 213
LMPDepthOffset, 5
MatScalingOffset, 23364
RFPEvalThreshold, 148
HistoryLMRScale, 1178
RFPDepthLimit, 8
SEReductionOffset, 2
FPBaseOffset, 9
BadCaptureMalus, 117
FPEvalMargin, 263
MatScalingDivisor, 33324
BaseLMRScale, 436
SEMinDepth, 4
""".replace(" ", "")
