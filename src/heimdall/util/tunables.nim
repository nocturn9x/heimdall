...
FPDepthLimit, 5
IIRMinDepth, 2
AspWindowMaxSize, 1039
LMRPvMovenumber, 4
AspWindowDepthThreshold, 5
DoubleExtMargin, 37
CutNodeLMRScale, 2104
NodeTMBaseOffset, 2697
NMPEvalMinimum, 3
NodeTMDepthThreshold, 5
SEEPruningQuietMargin, 77
SEEPruningCaptureMargin, 158
NMPEvalDivisor, 230
BadQuietMalus, 347
SEReductionDivisor, 2
TTCaptureLMRScale, 1056
NMPDepthThreshold, 1
...
GoodQuietBonus, 210
LMPDepthOffset, 5
MatScalingOffset, 23480
RFPEvalThreshold, 149
HistoryLMRScale, 1153
RFPDepthLimit, 8
SEReductionOffset, 2
FPBaseOffset, 8
BadCaptureMalus, 115
FPEvalMargin, 259
MatScalingDivisor, 33635
BaseLMRScale, 436
SEMinDepth, 4
""".replace(" ", "")
