...
const HELP_TEXT* = """heimdall help menu:
    ...
    - getStats <book> : Collect statistics about an opening book
    - getScale <o> <n>: Print the new expected eval scale given the old (o) and new (n)
                        absolute mean values returned by getStats
"""