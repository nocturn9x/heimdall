...
func createMove*(startSquare: Bitboard, targetSquare: Square, flag: MoveFlag): Move {.inline, noinit.} =
    result = createMove(startSquare.toSquare(), targetSquare, flag)


func createMove*(startSquare: Square, targetSquare: Bitboard, flag: MoveFlag): Move {.inline, noinit.} =
    result = createMove(startSquare, targetSquare.toSquare(), flag)


func createMove*(startSquare, targetSquare: Bitboard, flag: MoveFlag): Move {.inline, noinit.} =
