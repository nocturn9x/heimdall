...
**If `linux-universal` does not start or does not work in your chess GUI, use
the standalone download for your CPU:**

- **Intel or AMD (x86-64):** `linux-amd64-universal.tar.gz`
